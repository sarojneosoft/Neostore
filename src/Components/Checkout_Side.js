 ...
 * @description this method is responsible for  all the navlinks in the my account section 
 * @returns JSX for Side Screen
 */
  ...
  return (
    <Container>
      <Row>
        <Col>
          <p
            className="bg-dark text-white display-6 p-2 text-center rounded mt-2"
            style={{ width: "50%" }}
          >
            My Account
          </p>
