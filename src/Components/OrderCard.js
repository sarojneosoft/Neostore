 ...
 * @description this method is responsible for generating cards on the basis of received props
 * @param {props} takes the order data as props
 * @returns JSX for Order card section
 */
